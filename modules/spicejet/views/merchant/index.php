...
<div class="container">
	...
	<div class="approvalpage">
		<ul class="nav nav-tabs" role="tablist">
			...
			<li><a href="#accmange" aria-controls="accmange" role="tab" data-toggle="tab">Account Management</a></li>
		...
		<div class="tab-content">
			<div role="tabpanel" class="tab-pane active" id="userlist">
					...
					<div class="tablebox">	
					  ...
					  <ul class="pager pull-right">
						<li><a href="javascript:void(0)" id="1" class="previous 0" onClick="previous()" class="previous"><span class="glyphicon glyphicon-chevron-left"></a></li>
			...
			<div role="tabpanel" class="tab-pane" id="cardapp">
				...
				<div class="tablebox">	
						...
						<tr class="searchrow">
							<td class="idnum">&nbsp;</td>
							<td><input type="text" class="form-control searchid" id="agent_id_search" ></td>
							<td><input type="text" class="form-control searchid" id="email_search"></td>
							<td><input type="text" class="form-control searchid" id="payment_instrument_search"></td>
							<td class="action">&nbsp;</td>
						</tr>
						</thead>
						...
						<nav class="pagenav">
						<ul class="pager pull-right">
							<li><a href="javascript:void(0)" id="1" class="previous 0" onClick="previous_card()" class="previous_card"><span class="glyphicon glyphicon-chevron-left"></a></li>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
			<div class="col-sm-6 col-md-5 col-lg-4">
				<div class="form-group">					
				<input type="submit" class="btn btn-primary lg-btn" id="updatebtn" value="Update"  data-dismiss="modal" aria-label="Close">
				</div>
			</div>
		</div>
      </div>
     		...
     		type: "POST",
      		...
      		success: function(data) {
            	...
            	if(data['count_data'][0]['total']>0){
					...
					table_data = table_data+'<tr><td>'+(parseInt(index)+1)+'</td><td>'+value['GROUP_NAME']+'</td><td><div class="onoffswitch"><input type="checkbox"  id="onoffswitch1" name="group_status_'+value['AGNET_GROUP_ID']+'" onClick="Change_group_status('+value['AGNET_GROUP_ID']+')" class="onoffswitch-checkbox" '+checked+'><label class="onoffswitch-label" for="onoffswitch1"><span class="onoffswitch-inner"></span><span class="onoffswitch-switch"></span></label></div></td><td>'+date.getDate()+'-' + (date.getMonth()+1) + '-'+date.getFullYear()+'</td><td class="action"><div class="bbox"><a onClick="map_agent('+value['AGNET_GROUP_ID']+',\''+value['GROUP_NAME']+'\')" data-toggle="modal" data-target="#mapagency" title="Edit"><span class="glyphicon glyphicon-cog"></span></a></div></td></tr>';
								});
				}else{
