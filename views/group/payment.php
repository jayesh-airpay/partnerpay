...
<div class="row">
    <div class="col-md-12">
        <div class="invoice-head"><b>Invoice No :</b>
            <?php echo  !empty($model->ATTACHMENT)?$model->GROUP_INVOICE_ID. '':$model->GROUP_INVOICE_ID; ?>
            <?php //echo  !empty($model->ATTACHMENT)?$model->GROUP_INVOICE_ID.' ('.\yii\helpers\Html::a(' Click here to view invoice', ["uploads/attachment/$model->ATTACHMENT"], ['target'=>'_blank']).')':$model->GROUP_INVOICE_ID; ?></div>
    </div>
</div>
